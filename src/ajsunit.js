/*
 * The source code and documention of this project are available on https://github.com/phstc/ajsunit
  ...
  var show = function(){
    if(document.getElementsByTagName("h1").length === 0){
      createHTMLElement(document.body,
        "h1",
        'Yes, it is an <a href="http://github.com/phstc/ajsunit">Another JavaScript Unit Test library</a>'
        );
    }
